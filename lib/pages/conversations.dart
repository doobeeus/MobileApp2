import 'package:hw2/model/conversation.dart';
import 'package:hw2/pages/chat.dart';
import 'package:hw2/pages/create_conversation.dart';
    ...
    for (var user in convo.users) {
      if (user != _fs.getUserId()) {
        if (convoname.isEmpty) {
          convoname = FirestoreService.userMap[user]!.firstName;
        } else {
          convoname += ", ${FirestoreService.userMap[user]!.firstName}";
        }
      }
